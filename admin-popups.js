...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        popups.forEach(popup => {
            ...
            // Käytä event listeneriä inline onclick:in sijaan
        ...
        // Lisää tapahtumakuuntelijat napeille
    ...
    // Aseta lomakekenttien kuuntelijat
    setupEditFormListeners();
    
    // Rekisteröi lomakkeen lähetys
    updatePopup();
});
...
function setupEditFormListeners() {
    const editFields = ['editPopupType','editWidth','editHeight','editPosition','editAnimation',
                       'editBackgroundColor','editTextColor','editContent','editDelay',
                       'editShowDuration','editStartDate','editEndDate'];
