    ...
    <div style="max-width:820px;font-family:system-ui,sans-serif">
      ...
      ${section('fa-robot','Chatbots','AI chatbot or Q&A bot embedded on your website with one line of code', [
        ...
        [
          ...
          ['Button gradient','Tick "Use gradient" to give the launcher button a two-colour gradient for a more premium look.'],
          ['Grabber text','Optional speech-bubble text that appears next to the button, e.g. "Ask us anything!"'],
          ['Header & logo','Choose a solid or gradient header bar, set the status text (e.g. "Online"), and upload your company logo straight into the header. Use a transparent PNG for best results.'],
          ['Chat window background','Three options: a single colour, a two-colour gradient, or a full background image you upload. With gradient/image the input bar gets a frosted backdrop so text stays readable.'],
          ['Font','Pick the chat font: System, Inter, Poppins, Roboto or Nunito to match your brand.'],
          ['Live preview','The preview on the right shows both the button and the open window. Save to apply changes.'],
        ]),
    ...
    <div style="max-width:820px;font-family:system-ui,sans-serif">
      ...
      ${section('fa-robot','Chatbotit','Tekoälychatbotti tai Q&A-botti sivustollesi yhdellä koodirivilla', [
        ...
        [
          ...
          ['Napin liukuväri','Rastita "Käytä liukuväriä" antaaksesi napille kaksivärisen liukuvärin – näyttävämpi, premium-ilme.'],
          ['Heräteteksti','Valinnainen puhepallon teksti napin vieressä, esim. "Kysy meiltä mitä vain!"'],
          ['Otsikkopalkki & logo','Valitse yksivärinen tai liukuväri-otsikkopalkki, aseta status-teksti (esim. "Online") ja lataa yrityksesi logo suoraan otsikkoon. Käytä läpinäkyvää PNG-kuvaa parhaan tuloksen saamiseksi.'],
          ['Chat-ikkunan tausta','Kolme vaihtoehtoa: yksi väri, kaksivärinen liukuväri tai koko taustakuva jonka lataat. Liukuvärin/kuvan kanssa syötepalkki saa huurretun taustan, jotta teksti pysyy luettavana.'],
          ['Fontti','Valitse chatin fontti: Järjestelmä, Inter, Poppins, Roboto tai Nunito – brändisi mukaan.'],
          ['Esikatselu','Oikealla näkyvä esikatselu näyttää sekä napin että avatun ikkunan. Tallenna ottaaksesi muutokset käyttöön.'],
        ]),
